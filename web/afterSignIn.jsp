        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
    <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-user"></i>Usta Armen <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-fw fa-star"></i> Interested</a>
                        </li>
                        <li>
